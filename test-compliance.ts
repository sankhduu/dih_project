 ...
 * Run via: npx tsx test-compliance.ts
 */

import { calculateMPE, getValidityPeriodYears } from './src/lib/metrology-rules';
import { generateCertificateHash } from './src/lib/crypto-utils';
import { MOCK_JURISDICTIONS } from './src/lib/mock-data';
